...
const playlistDetail_router_1 = require("./playlistDetail-router");
exports.router = (0, express_1.Router)();
exports.router.use('/songs', song_router_1.songRouter);
exports.router.use('/playlists', playlist_router_1.playlistRouter);
exports.router.use('/playlistDetails', playlistDetail_router_1.playlistDetailRouter);
